...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "MAD";
    ...
    void addHiScore(com.example.S00201033.HiScore hiScore) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    com.example.S00201033.HiScore getHiScore(int id) {
        ...
        com.example.S00201033.HiScore hiScore = new com.example.S00201033.HiScore(Integer.parseInt(
                cursor.getString(0)),
                cursor.getString(1),
                cursor.getString(2),
                cursor.getInt(3));
    ...
    public List<com.example.S00201033.HiScore> getAllHiScores() {
        List<com.example.S00201033.HiScore> hiScoreList = new ArrayList<com.example.S00201033.HiScore>();
        // Select All Query
        ...
        if (cursor.moveToFirst()) {
            do {
                com.example.S00201033.HiScore hiScore = new com.example.S00201033.HiScore();
    ...
    public int updateHiScore(com.example.S00201033.HiScore hiScore) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public void deleteHiScore(com.example.S00201033.HiScore hiScore) {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public List<com.example.S00201033.HiScore> getTopFiveScores() {
        List<com.example.S00201033.HiScore> hiScoreList = new ArrayList<com.example.S00201033.HiScore>();
        // Select All Query
        String selectQuery = "SELECT  * FROM " + TABLE_HI_SCORES +
                " ORDER BY SCORE DESC " +
